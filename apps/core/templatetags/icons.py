...
ICONS = {
    ...
    "bank": '<path d="M3 22h18"/><path d="M6 18v-7"/><path d="M10 18v-7"/><path d="M14 18v-7"/><path d="M18 18v-7"/><path d="m2 10 10-6 10 6"/><path d="M4 10v8"/><path d="M20 10v8"/>',
    "landmark": '<path d="M3 22h18"/><path d="M6 18v-7"/><path d="M10 18v-7"/><path d="M14 18v-7"/><path d="M18 18v-7"/><path d="m2 10 10-6 10 6"/><path d="M4 10v8"/><path d="M20 10v8"/>',
    ...
    "globe-2": '<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',
    ...
    "zap-off": '<path d="M12.41 6.75a1.13 1.13 0 0 1 1.96 0l1.07 1.59a1.13 1.13 0 0 0 1.96 0l1.07-1.59a1.13 1.13 0 0 1 1.96 0L21.75 9"/><path d="M4.5 9h3.5l2.5 12 2.5-9H19.5"/><path d="m2 2 20 20"/>',
    "sparkles-2": '<path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275 1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/>',
}
